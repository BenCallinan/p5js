...
function setup() {
    ...
    for (let i = 0; i < 8; i++) {
        ...
        tris[i] = new Tri(random(170, 200), y4, 195, y5, random(190, 220), y6);
        ...
        circTri[i] = new CircTri(250, yc1, random(235, 265), yt1, random(235, 265), yt2, 250, yt3);
        ...
        sqrTri[i] = new SqrTri(415, ys2, random(395, 425), yt4, random(405, 435), yt5, 415, yt6);
    }
}
