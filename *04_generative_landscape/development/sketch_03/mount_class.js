...
class LittleM {
    constructor(x) {
    	...
    	this.mount2X = x + random(40, 50);
    	this.mount2Y = random(200, 350);

    	this.mount3X = x + random(80, 100);
    	this.mount3Y = random(200, 350);

    	this.mount4X = x + random(120, 150);
    	this.mount4Y = random(200, 350);

    	this.mount5X = x + random(160, 200);
    ...
    show() {
    	...
    	vertex(this.mount3X, this.mount3Y);
    	vertex(this.mount4X, this.mount4Y);
        vertex(this.mount5X, this.mount5Y);
