...
function setup() {
    ...
    // let vignette = seriously.effect('vignette');
    // vignette.amount = '#blur-slider';
    // vignette.source = src;
    // target.source = vignette;

    let bleachBypass = seriously.effect('bleach-bypass');
    bleachBypass.amount = '#blur-slider';
    bleachBypass.source = src;
    target.source = bleachBypass;
